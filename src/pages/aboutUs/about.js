...
export default function About() {
    ...
    return (
        ...
        <ul>
            <li>**Paixão por Tênis:** Vivemos e respiramos a cultura sneaker. Estamos sempre antenados nas novidades, nos clássicos e nas tecnologias que moldam o futuro do calçado.</li>
            <li>**Qualidade e Autenticidade:** Trabalhamos apenas com marcas renomadas e garantimos que cada par de tênis em nosso catálogo é 100% original e de alta qualidade. Sua confiança é nosso maior valor.</li>
            <li>**Conforto para Cada Passo:** Acreditamos que o conforto não é um luxo, mas uma necessidade. Nossos produtos são selecionados pensando no seu bem-estar, seja para o dia a dia, para o esporte ou para momentos especiais.</li>
            <li>**Estilo que Inspira:** De clássicos atemporais a lançamentos exclusivos, curamos uma coleção diversificada para que você encontre o par perfeito que reflete sua identidade e te ajuda a se destacar.</li>
            <li>**Experiência Descomplicada:** Queremos que sua jornada de compra seja tão suave quanto o seu tênis novo. Nosso site é intuitivo, nosso atendimento é próximo e nossa entrega é ágil.</li>
        </ul>
